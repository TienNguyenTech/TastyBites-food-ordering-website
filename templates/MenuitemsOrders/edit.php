...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $menuitemsOrder->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $menuitemsOrder->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="menuitemsOrders form content">
            ...
            <fieldset>
                <legend><?= __('Edit Menuitems Order') ?></legend>
                <?php
